        ...
        <div className="bg-white p-6 rounded-2xl border border-stone/15 shadow-xs space-y-5">
          ...
          {images.filter(img => img && img.trim()).length > 0 ? (
            ...
            <p className="text-xs text-stone italic text-center py-2">
              Aucune photo ajoutée pour le moment. Cliquez sur le cadre ci-dessus pour importer vos photos.
            </p>
          )}
            ...
            <div className="mt-3 space-y-2">
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={() => {
                    const input = document.getElementById('new-manual-url-input') as HTMLInputElement;
